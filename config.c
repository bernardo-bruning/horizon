...
static const struct horizon_key_binding default_bindings[] = {
	{
		...
		.keysym = XKB_KEY_h,
		.keycode = KEY_H,
		.action = HORIZON_ACTION_FOCUS_DIRECTION,
		.argument = HORIZON_DIRECTION_LEFT,
	},
	{
		.modifiers = WLR_MODIFIER_LOGO,
		.keysym = XKB_KEY_Left,
	...
	},
	{
		...
		.keycode = KEY_J,
		.action = HORIZON_ACTION_FOCUS_DIRECTION,
		.argument = HORIZON_DIRECTION_DOWN,
	},
	{
		.modifiers = WLR_MODIFIER_LOGO,
		.keysym = XKB_KEY_Down,
	...
	},
	{
		...
		.keycode = KEY_L,
		.action = HORIZON_ACTION_FOCUS_DIRECTION,
		.argument = HORIZON_DIRECTION_RIGHT,
	},
	{
		.modifiers = WLR_MODIFIER_LOGO,
