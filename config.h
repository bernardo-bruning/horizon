...
enum horizon_action {
	...
	HORIZON_ACTION_CLOSE_WINDOW,
	HORIZON_ACTION_FOCUS_DIRECTION,
	HORIZON_ACTION_TOGGLE_MAXIMIZE,
	HORIZON_ACTION_FULLSCREEN,
};

enum horizon_focus_direction {
	HORIZON_DIRECTION_LEFT,
	HORIZON_DIRECTION_DOWN,
	HORIZON_DIRECTION_UP,
	HORIZON_DIRECTION_RIGHT,
};
